...
const Navbar = () => {
  ...
  const handleSignOut = () =>{
    ...
    return (
        <div className="navbar shadow-lg px-4  md:px-10">
    ...
    <DarkMode></DarkMode>
  {
...

        {
          ...
          {
            user?   <button onClick={handleSignOut} className="btn bg-red-500 text-white rounded-3xl hover:text-black  text-lg font-semibold">Sign Out</button>:
            <Link to="/login">
